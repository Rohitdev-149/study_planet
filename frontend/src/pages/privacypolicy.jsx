        ...
        <TitleWrapper className="text-center">
          <PolicyWrapper className="privacy">
            ...
            <Paragraph>Last updated: June 8, 2024</Paragraph>
              <Paragraph>
                Welcome to studyplanet. We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy or our practices with regards to your personal information, please contact us at support@studyplanet.com.
              </Paragraph>
            </Section>
            <Section className="text-left">
            ...
            <Section className="text-left">
              ...
              <Paragraph>
                If you have questions or comments about this policy, you may email us at: <a href="mailto:support@studyplanet.com">support@studyplanet.com</a>.
              </Paragraph>
            </Section>
          </PolicyWrapper>
        </TitleWrapper>
