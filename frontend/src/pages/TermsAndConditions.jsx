          ...
          <TitleWrapper className="text-center">
            <PolicyWrapper className="terms">
              <Section className="text-left">
                ...
                <Paragraph>
                  Welcome to studyplanet. These terms and conditions outline the rules and regulations for the use of studyplanet's Website, located at www.studyplanet.com.
                </Paragraph>
              </Section>
              <Section className="text-left">
              ...
              <Section className="text-left">
                ...
                <Paragraph>
                  Unless otherwise stated, studyplanet and/or its licensors own the intellectual property rights for all material on studyplanet. All intellectual property rights are reserved.
                </Paragraph>
              </Section>
              <Section className="text-left">
              ...
              <Section className="text-left">
                ...
                <Paragraph>
                  You retain ownership of any intellectual property rights that you hold in the content you submit to the platform. By submitting, posting, or displaying content on or through the platform, you grant studyplanet a worldwide, non-exclusive, royalty-free license to use, copy, reproduce, process, adapt, modify, publish, transmit, display, and distribute such content in any and all media or distribution methods.
                </Paragraph>
              </Section>
              <Section className="text-left">
                <Heading2>Indemnification</Heading2>
                <Paragraph>
                  You agree to indemnify and hold studyplanet and its affiliates, directors, officers, employees, and agents harmless from and against any liabilities, losses, damages, or costs, including reasonable attorneys' fees, incurred in connection with or arising from any third-party allegations, claims, actions, disputes, or demands asserted against any of them as a result of or relating to your content, your use of the platform, or any willful misconduct on your part.
                </Paragraph>
              </Section>
              <Section className="text-left">
                <Heading2>Modifications to the Service</Heading2>
                <Paragraph>
                  studyplanet reserves the right to modify or discontinue, temporarily or permanently, the platform or any part of it with or without notice. You agree that studyplanet shall not be liable to you or any third party for any modification, suspension, or discontinuance of the platform.
                </Paragraph>
              </Section>
              <Section className="text-left">
                <Heading2>Termination</Heading2>
                <Paragraph>
                  studyplanet may terminate or suspend access to the platform immediately, without prior notice or liability, for any reason whatsoever, including without limitation if you breach the terms.
                </Paragraph>
              </Section>
              <Section className="text-left">
              ...
              <Section className="text-left">
                ...
                <Paragraph>
                  ...
                  <br />please contact us at: Email: support@studyplanet.com
                </Paragraph>
              </Section>
            </PolicyWrapper>
          </TitleWrapper>
