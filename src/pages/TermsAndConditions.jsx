          ...
          <TitleWrapper className="text-center">
            <PolicyWrapper className="terms">
              <Section className="text-left">
                ...
                <Paragraph>
                  Welcome to StudyPlanet. These terms and conditions outline the
                  rules and regulations for the use of StudyPlanet's Website,
                  located at www.studyplanet.com.
                </Paragraph>
              </Section>
              <Section className="text-left">
              ...
              <Section className="text-left">
                ...
                <Paragraph>
                  Unless otherwise stated, StudyPlanet and/or its licensors own
                  the intellectual property rights for all material on
                  StudyPlanet. All intellectual property rights are reserved.
                </Paragraph>
              </Section>
              <Section className="text-left">
                <Heading2>Use of Our Platform</Heading2>
                <Paragraph>
                  By using StudyPlanet, you agree to abide by the following
              ...
              <Section className="text-left">
                ...
                <Paragraph>
                  ...
                  platform, you grant StudyPlanet a worldwide, non-exclusive,
              ...
              <Section className="text-left">
                ...
                <Paragraph>
                  You agree to indemnify and hold StudyPlanet and its
              ...
              <Section className="text-left">
                ...
                <Paragraph>
                  StudyPlanet reserves the right to modify or discontinue,
                  temporarily or permanently, the platform or any part of it
                  with or without notice. You agree that StudyPlanet shall not
              ...
              <Section className="text-left">
                ...
                <Paragraph>
                  StudyPlanet may terminate or suspend access to the platform
              ...
              <Section className="text-left">
                ...
                <Paragraph>
                  ...
                  <br />
                  please contact us at: Email: support@studyplanet.com
                </Paragraph>
              </Section>
            </PolicyWrapper>
          </TitleWrapper>
