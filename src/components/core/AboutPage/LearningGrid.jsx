...
const LearningGridArray = [
  ...
  },
  {
    ...
    description:
      "StudyPlanet provides industry-recognized certification to validate your new skills and enhance your career prospects.",
  },
  {
    order: 4,
    heading: `Rating "Auto-grading"`,
    description:
      "StudyPlanet’s auto-grading feature provides instant, objective feedback to help learners assess their understanding and progress efficiently.",
  },
  {
    order: 5,
    heading: "Ready to Work",
    description:
      "StudyPlanet equips learners with job-ready skills, preparing them to excel in the workforce.",
  },
];
